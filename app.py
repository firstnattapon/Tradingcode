...
if __name__ == '__main__':
    if st.checkbox('inverse(ผกผัน)'):
        ...
        Asset_prices    = st.number_input('Asset_prices_inverse', min_value=0.0 ,max_value= upper_inverse ,value=0.0,step=0.1,format='%f')
    ...
    if st.checkbox('Direct(ผันตรง)'):
        ...
        Asset_prices    = st.number_input('Asset_prices_Direct', min_value=0.0 ,max_value= upper_Direct ,value=0.0,step=0.1,format='%f')
